export function HamburgerMenu({ openMenu, open, darkmode }) {
  return (
    <div onClick={openMenu} className="group relative flex flex-col shrink-0 md:hidden mx-6 justify-between items-center h-4.5 transition-all duration-300 ease-in-out origin-center">
